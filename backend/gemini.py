...
def code_review(codebase):
    ...
    response = model.generate_content(f"""  I am giving you to inputs a, an entire codebase:{codebase} and a list of evaluation criteria for this codebase {code_metrics}. 
                                            ...
                                            IT IS CURCIAL THAT YOU FOLLOW THE template and the EXAMPLES within the TEMPLATE. 
                                            IT IS ALSO CRUCIAL that the PRO/CON Bullets are EACH MAX 25 WORDS and THERE IS EXACTLY 3 FOR both Pros and Cons.
                                      """)
